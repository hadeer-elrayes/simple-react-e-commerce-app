...
import background from '../img/icons/icon-cart-big.svg';
import background2 from '../img/PersonalImage.png';
      ...
      render() { 
        ...
        <div className="header__middle container">
            ...
            <div className="header__user-options">
                ...
                <div className="dropdown">
                    <div className="dropdown__header">
                        <div className="image image--small image--circle" style={{backgroundImage: `url(${background2})` , marginLeft:1000}}>
                        </div>
                    </div>
                    <div className="dropdown__body">
                ...
                <div className="dropdown dropdown--left  ">
                    ...
                    <div className="dropdown__header">
                        <div className="image image--small" style={{backgroundImage: `url(${background})`}}>
                ...
                <ul className="nav__items list list--hr">
                    ...
                    <li className="nav__item dropdown ">
                        ...
                        <div className="dropdown__body">
                            <ul className=" list">
                                <li className="list__item">
                                    <Link  to="/products" className="nav__inner-link">Product Listing</Link>
                                </li>
                                <li className="list__item">
                                <Link  to="/form" className="nav__inner-link">Add Product</Link>
                                </li>
                            </ul>
                        </div>
                    </li>
